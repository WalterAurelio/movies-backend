...
export interface IUserController {
  registerUser: (req: Request<{}, {}, RegisterBody>, res: Response) => Promise<void>
}
...
//     if (!foundUser) return res.status(401).json({ message: 'No existe un usuario registrado con este correo electrónico.' });
